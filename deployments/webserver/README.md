...
Module `sdkwork-invoice` · runtime code `invoice` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `invoice-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `invoice-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `invoice-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `invoice-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `invoice.sdkwork.com` | 443 ssl + 80 |
