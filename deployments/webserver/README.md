...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `invoice-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `invoice-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `invoice-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `invoice-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `invoice.sdkwork.com` | 443 ssl + 80 |
