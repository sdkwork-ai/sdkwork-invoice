# Runbook — sdkwork-invoice deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-invoice-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-invoice/bundle`, loads the image, starts
